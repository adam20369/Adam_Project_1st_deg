...
def Run_Cluster_Sparse_Time_prop(n_PXP, n_TI, h_c ,T_start, T_max, T_step):
    ...
    '''
    try:
        os.mkdir('PXP_{}_TI_{}_P_iminus1_X_i'.format(n_PXP, n_TI))
    except:
        pass
    try:
        os.mkdir('PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c))
    except:
        pass
    if os.path.isfile('PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}/Sparse_time_propagation_P_iminus1_X_i_{}_{}_{}_sample_{}.npy'.format(n_PXP,n_TI,h_c,n_PXP,n_TI,h_c,seed)) == False:
        ...
        np.save(os.path.join('PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_{}_{}_{}_sample_{}.npy'.format(n_PXP,n_TI,h_c,seed)), Sandwich)
    return
...
def Sparse_time_combine(seed_max):
    ...
    for j in range(1,seed_max):
        data[j-1,:]= np.load(os.getcwd()+os.path.join('/PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_{}_{}_{}_sample_{}.npy'.format(n_PXP,n_TI,h_c,j))) #creates
    np.save(os.path.join('PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_combine_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)), data)
...
def Sparse_time_ave():
    ...
    :return: saves average
    '''
    data= np.load(os.getcwd()+os.path.join('/PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_combine_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)))
    data_ave = np.mean(data,axis=0)
    np.save(os.path.join('PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_ave_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)), data_ave)
...
def Bootstrap_confidence(Sample_no):
    ...
    np.save(os.path.join('PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_errors_confidence_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)),lower_upper)
...
def Bootstrap_std(Sample_no):
    ...
    np.save(os.path.join('PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_errors_std_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)),std_vec)
...
def avg_data_move():
    ...
    '''
    data_ave = np.load(os.getcwd()+os.path.join('/PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_ave_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)))
    data_err_std = np.load(os.getcwd()+os.path.join('/PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_errors_std_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)))
    data_err_confidence = np.load(os.getcwd()+os.path.join('/PXP_{}_TI_{}_P_iminus1_X_i/h_c_{}'.format(n_PXP,n_TI,h_c),'Sparse_time_propagation_P_iminus1_X_i_errors_confidence_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)))
    try:
        os.mkdir('PXP_{}_P_iminus1_X_i_Osc_Ave'.format(n_PXP))
    except:
        pass
    np.save(os.path.join('PXP_{}_P_iminus1_X_i_Osc_Ave'.format(n_PXP),'Sparse_time_propagation_P_iminus1_X_i_ave_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)),data_ave)
    np.save(os.path.join('PXP_{}_P_iminus1_X_i_Osc_Ave'.format(n_PXP),'Sparse_time_propagation_P_iminus1_X_i_errors_std_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)),data_err_std)
    np.save(os.path.join('PXP_{}_P_iminus1_X_i_Osc_Ave'.format(n_PXP),'Sparse_time_propagation_P_iminus1_X_i_errors_confidence_{}_{}_{}.npy'.format(n_PXP,n_TI,h_c)),data_err_confidence)
#avg_data_move()