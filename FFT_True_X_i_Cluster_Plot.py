...
def Plot_vs_h_c_diff_n_TI_condifence_True_X_i():
    '''
    ...
    for j in np.nditer(n_TI):
        ...
        for i in np.nditer(h_c):
            data_ave[count]=np.load('PXP_{}_True_X_i_Gammas_cutoff_{}_{}/Gamma_ave_True_X_i_{}_{}_{}_cutoff_{}_{}.npy'.format(n_PXP,Start_cutoff,End_cutoff,n_PXP,int(j),np.round(i,1),Start_cutoff,End_cutoff))
            #print(data_ave)
            data_errors[:,count]=np.load('PXP_{}_True_X_i_Gammas_cutoff_{}_{}/Gamma_errors_confidence_True_X_i_{}_{}_{}_cutoff_{}_{}.npy'.format(n_PXP,Start_cutoff,End_cutoff,n_PXP,int(j),np.round(i,1),Start_cutoff,End_cutoff))
            #print(data_errors)
            count=count+1
    ...
    plt.title(r'$XX$ coupling normalized damping for {} PXP atoms vs $h_c$, cutoff {}-{}'.format(n_PXP,Start_cutoff,End_cutoff))
    plt.ylabel(r' Normalized Damping $\frac{\gamma}{\gamma_0}$', fontsize=10)
    plt.xlabel(r'Coupling Strength $h_c$',fontsize=12)
    plt.legend()
    #plt.savefig('Figures/True_X_i_Osc/XX_damping_{}_PXP_vs_h_c_{}_confi_err_cutoff_{}_{}.png'.format(n_PXP,h_c_max,Start_cutoff,End_cutoff))
    return plt.show()
#Plot_vs_h_c_diff_n_TI_condifence_True_X_i()

def Plot_vs_h_c_diff_n_TI_std_True_X_i():
    '''
    Plot for different TI numbers, a normalized damping graph vs Coupling strength h_c
    :return: a plot of plots
    '''
    ...
    for j in np.nditer(n_TI):
        ...
        for i in np.nditer(h_c):
            data_ave[count]=np.load('PXP_{}_True_X_i_Gammas_cutoff_{}_{}/Gamma_ave_True_X_i_{}_{}_{}_cutoff_{}_{}.npy'.format(n_PXP,Start_cutoff,End_cutoff,n_PXP,int(j),np.round(i,1),Start_cutoff,End_cutoff))
            #print(data_ave)
            data_errors[count]=np.load('PXP_{}_True_X_i_Gammas_cutoff_{}_{}/Gamma_errors_std_True_X_i_{}_{}_{}_cutoff_{}_{}.npy'.format(n_PXP,Start_cutoff,End_cutoff,n_PXP,int(j),np.round(i,1),Start_cutoff,End_cutoff))
            #print(data_errors)
            count=count+1
    ...
    plt.xlabel(r'Coupling Strength $h_c$',fontsize=12)
    plt.legend()
    #plt.savefig('Figures/True_X_i_Osc/XX_damping_{}_PXP_vs_h_c_{}_std_err_cutoff_{}_{}.png'.format(n_PXP,h_c_max,Start_cutoff,End_cutoff))
    return plt.show()
#Plot_vs_h_c_diff_n_TI_std_True_X_i()

def Plot_vs_h_c_diff_n_TI_Rel_Err_new_True_X_i():
    '''
    ...
    for j in np.nditer(n_TI):
        ...
        for i in np.nditer(h_c): # Z_i CASE
            data_ave[count] = np.load('PXP_{}_True_X_i_Gammas_cutoff_{}_{}/Gamma_ave_True_X_i_{}_{}_{}_cutoff_{}_{}.npy'.format(n_PXP, Start_cutoff, End_cutoff,n_PXP, int(j), np.round(i, 1),Start_cutoff, End_cutoff))
            # print(data_ave)
            data_errors[count] = np.load('PXP_{}_True_X_i_Gammas_cutoff_{}_{}/Gamma_error_ave_True_X_i_{}_{}_{}_cutoff_{}_{}.npy'.format(n_PXP, Start_cutoff,End_cutoff, n_PXP,int(j), np.round(i, 1),Start_cutoff,End_cutoff))
            # print(data_errors)
            count=count+1
    ...
    return plt.show()
Plot_vs_h_c_diff_n_TI_Rel_Err_new_True_X_i()
